...
def cmd_run(args):
    port = int(os.getenv("RAVVI_POKER_WS_PORT", "5001"))
    uvicorn.run("ravvi_poker.ws.app:app", host="0.0.0.0", port=port, log_level="info")


def main():
    parser = argparse.ArgumentParser(usage="ravvi_poker_ws [-h] OPTIONS COMMAND ...")
