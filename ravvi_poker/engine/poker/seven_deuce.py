...
class SevenDeuceController:
    ...
    async def handle_winners(self, winners_info: dict, players: list[Player]):
        ...
        winners_info = await self.form_winners(players, winners_seven_deuce_user_id, bank_seven_deuce)

        return bank_seven_deuce, winners_info

    async def collect_winners(self, winners_info: dict, players: list[Player]):
        bank_seven_deuce = 0
        winners_seven_deuce_user_id = []
    ...
    async def form_winners(self, players: list[Player], winners_seven_deuce_user_id: list, bank_seven_deuce: float):
        winners_info = []
