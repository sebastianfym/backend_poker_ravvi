...
from ..db import DBI
from ..game.event import Event, TABLE_INFO, TABLE_CLOSED, PLAYER_ENTER, PLAYER_EXIT
...
class Table(ObjectLogger):
    ...
    async def handle_user_join(self, user_id, client_id, take_seat):
        user_seat_idx = None
        seats_available = []
        ...
        user.connected = len(user.clients)
        ...
        event = self.get_TABLE_INFO(user_id)
    ...
    def remove_connection(self, user_id, client_id):
        pass
