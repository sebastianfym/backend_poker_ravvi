create or replace procedure create_txn_MOVEIN(operator_id bigint, _club_id bigint, _user_id bigint, in ref_user_id bigint, in txn_value numeric, out txn_id bigint) 
language plpgsql
as $body$
declare
    member_id bigint;
...
begin
	...
	insert into chips_txn
		...
		values 
        (_club_id, operator_id, 'MOVEIN', txn_value, member_id, ref_member_id) returning id into txn_id;
